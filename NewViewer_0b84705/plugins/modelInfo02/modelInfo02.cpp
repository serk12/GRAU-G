#include "modelInfo02.h"

void ModelInfo02::onPluginLoad()
{
...
//	string text = "#objects: "  + to_string(obj.size())  + "#poligons: "  + to_string(qttyFaces) + "\n#vertices: " + to_string(qttyVert) + "\n#perTrian: " + to_string(((qttyTri/qttyFaces)*100)) + "%\n";
    ...
    int x = 15;
    int y = 50;
    painter.drawText(x, y,      "#objects: "  + QString::number(obj.size()));
	painter.drawText(x, y + 35, "#poligons: " + QString::number(qttyFaces));   
	painter.drawText(x, y + 70, "#vertices: " + QString::number(qttyVert));   
	painter.drawText(x, y +105, "#perTrian: " + QString::number(((qttyTri/qttyFaces)*100)) + "%");       
    painter.end();
...
Q_EXPORT_PLUGIN2(modelInfo02, ModelInfo02)   // plugin name, plugin class
#endif
